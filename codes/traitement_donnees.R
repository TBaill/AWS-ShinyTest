...
#shape_path <- "C:/Users/basse_000/Documents/R_PROG/Leaflet_test/ne_50m_admin_1_states_provinces"
#prov_shapefile <- paste(shape_path, "ne_50m_admin_1_states_provinces.shp", sep="/")

provinces <- readOGR(dsn = 'data/ne_50m_admin_1_states_provinces.shp',layer = "ne_50m_admin_1_states_provinces")

map_CAN_data <- merge(provinces, Transport_2018, by.x="gn_name",by.y="STATE")
...
labels <- sprintf(
  ...
  map_CAN_data$gn_name, map_CAN_data$Nb_aff, map_CAN_data$Revenus_aff, map_CAN_data$Marge_aff
